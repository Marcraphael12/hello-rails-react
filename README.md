...
**hello-rails-react** is an app using React and Rails in one app.
...
<details>
  ...
  <ul>
    <li><a href="https://www.postgresql.org/">React-Redux</a></li>
  </ul>
</details>
...
```sh
  cd project-folder
  git clone git@github.com:JavierAybar/hello-rails-react.git
```
...
- GitHub: [@JavierAybar](https://github.com/Marcraphael12)
- LinkedIn: [@JavierAybar](https://www.linkedin.com/in/marc-raphael-essogo-bidzogo)
